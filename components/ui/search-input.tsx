...
export function SearchInput({
  ...
  return (
    ...
    >
      <canvas
        className={cn(
          "absolute pointer-events-none intext-base transform scale-50 top-[20%] left-2 sm:left-8 origin-top-left filter invert dark:invert-0 pr-20",
